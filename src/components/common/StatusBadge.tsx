  ...
  switch (status) {
    ...
    case 'researching':
      return {
        label: 'Researching',
        percentage: 50,
        badgeClass: 'bg-blue-50 text-blue-700 dark:bg-blue-950/40 dark:text-blue-400 border-blue-200/60 dark:border-blue-800/60',
    ...
    case 'generating':
      return {
        label: 'Generating',
        percentage: 75,
        badgeClass: 'bg-purple-50 text-purple-700 dark:bg-purple-950/40 dark:text-purple-400 border-purple-200/60 dark:border-purple-800/60',
    ...
    case 'processing':
      return {
        label: 'Processing',
        percentage: 60,
        badgeClass: 'bg-indigo-50 text-indigo-700 dark:bg-indigo-950/40 dark:text-indigo-400 border-indigo-200/60 dark:border-indigo-800/60',
...
export const StatusBadge: React.FC<StatusBadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center font-bold uppercase tracking-wider rounded-full border shadow-2xs ${details.badgeClass} ${sizeClasses}`}
    >
      {showIcon && (
